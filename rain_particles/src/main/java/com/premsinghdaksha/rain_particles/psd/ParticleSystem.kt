package com.premsinghdaksha.rain_particles.psd

import android.graphics.Color
import com.premsinghdaksha.rain_particles.psd.emitters.BurstEmitter
import com.premsinghdaksha.rain_particles.psd.emitters.Emitter
import com.premsinghdaksha.rain_particles.psd.emitters.RenderSystem
import com.premsinghdaksha.rain_particles.psd.emitters.StreamEmitter
...
class ParticleSystem(private val rainParticlesView: RainParticlesView) {
    ...
    private var confettiConfig = RainParticlesConfig()
     ...
     * Render function of the renderSystem is directly accessed from [RainParticlesView]
     */
     ...
     */
    private fun start() {
        rainParticlesView.start(this)
    }

    fun stop() {
        rainParticlesView.stop(this)
    }
